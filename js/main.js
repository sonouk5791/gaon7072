document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadSiteSettings() {
        ...
        if (footerHoursWeekday) footerHoursWeekday.textContent = settings.hoursWeekday || '09:00 ~ 18:00 (이후 당직 연결)';
        ...
        window.renderFaqList = function() {
            ...
            const defaultFaq = [
                ...
                { 
                    q: '요양등급이 아직 없는데 가온 서비스를 즉시 이용할 수 있나요?', 
                    a: '네, 가능합니다. 노인장기요양 등급이 없으신 경우, 가온의 전담 사회복지사가 국민건강보험공단 등급 신청 서류 작성부터 공단 직원의 방문 조사 대비 안내, 의사소견서 발급 동행 등 등급 판정 전 과정의 행정 절차를 100% 무료로 대행하여 최단기간 내 등급을 받으실 수 있도록 적극 도와드립니다. 등급 판정 전에도 일반 유료 요양 서비스 이용이 가능하니 우선 편하게 문의 주십시오.' 
                },
                { 
                    q: '방문요양 한 달 예상 서비스 비용은 대략 어떻게 되나요?', 
                    a: '국민건강보험공단 지원을 통해 총 요양 비용의 85% ~ 100%를 지원받으므로, 실제 본인이 부담하시는 금액은 월 기준 약 0원(기초생활수급자)에서 최대 20만 원대 초반 수준(일반 15% 부담 기준)입니다. 어르신의 장기요양 등급과 일주일간 이용하시는 일수/시간에 따라 상세 단가가 정해지므로, 홈페이지 하단의 지원금 계산기를 통해 모의 조회를 해보시거나 빠른 전화 상담을 신청해 주시면 최적의 본인부담 비용을 맞춤 안내해 드리겠습니다.' 
                }
            ];
